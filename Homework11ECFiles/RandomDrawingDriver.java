...
public class RandomDrawingDriver {
	...
	public static void main(String[] args) {
		...
		RandomDrawingInterface<String> stringDrawingLettersSpacesOnly = new RandomDrawingLimited<>(false, RandomDrawingDriver::containsOnlyLettersSpaces);
		...
		RandomDrawingInterface<Integer> numberDrawingEvensOnly = new RandomDrawingLimited<>(false, num -> num % 2 == 0);
		...
		RandomDrawingInterface<Employee> employeeDrawingEligibleOnly = new RandomDrawingLimited<>(false, Employee::isEligible); // YOUR CODE HERE TO INVOKE THE RandomDrawingLimited CONSTRUCTOR
